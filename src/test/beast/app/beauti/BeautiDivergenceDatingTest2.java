...
public class BeautiDivergenceDatingTest2 extends BeautiBase2 {
...
//        Component c = beautiFrame.robot().finder().findByName("addItem");
        ...
        Component c = finder.findByName("addItem");
        ...
        File fout = new File(Files.temporaryFolder() + "/primates.xml");
        if (fout.exists()) {
            fout.delete();
        }
...
//
//
//        fout = new File(Files.temporaryFolder() + "/divtutorial.xml");
//        if (fout.exists()) {
//            fout.delete();
//        }
...
//		makeSureXMLParses();
//
//		DivergenceDatingRunner runner = new DivergenceDatingRunner(Files.temporaryFolder());
// 		runner.analyse(0);
...
// 		//System.setProperty("file.name.prefix", Files.temporaryFolder().getAbsolutePath());
// 		DivergenceDatingRunner runner = new DivergenceDatingRunner(Files.temporaryFolder());
// 		runner.analyse(0);
// 		
// 	}
